...
HD_PWD='F:/TA/2023_Autumn/BRAM_demo/BRAM_demo.runs/bram_simp_dual_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bram_simp_dual.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bram_simp_dual.tcl
