...
HD_PWD='F:/TA/2023_Autumn/BRAM_demo/BRAM_demo.runs/bram_dual_port_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bram_dual_port.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bram_dual_port.tcl
